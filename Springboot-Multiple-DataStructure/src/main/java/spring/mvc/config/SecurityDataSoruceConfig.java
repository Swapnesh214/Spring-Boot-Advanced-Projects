...
@Configuration
@EnableJpaRepositories(basePackages = "spring.mvc.security.repository", entityManagerFactoryRef = "securityEntityManagerFactory", transactionManagerRef = "securityTransactionManager")
