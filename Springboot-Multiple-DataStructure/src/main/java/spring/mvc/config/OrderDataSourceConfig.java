...
@Configuration
@EnableJpaRepositories(basePackages = "spring.mvc.orders.repository", entityManagerFactoryRef = "ordersEntityManagerFactory", transactionManagerRef = "ordersTransactionManager")
public class OrderDataSourceConfig {
	...
	public LocalContainerEntityManagerFactoryBean ordersEntityManagerFactory() {
		...
		factory.setPackagesToScan(new String[] { "spring.mvc.orders.entities" });
